...
@NamedQueries({@NamedQuery(name="CentroCosto.findByNombre",query="Select c from CentroCosto c WHERE c.nombre =:nombre"),@NamedQuery(name="CentroCosto.findAllByEmpresa",query="Select cc from CentroCosto cc WHERE cc.empresa.id =:empresa_id")})
